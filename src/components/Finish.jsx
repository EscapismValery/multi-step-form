		...
		<CardForm active={4}>
			<MyForm>
				<div className='form-finish'>
					...
					<h3 className='form__title form-finish__title'>Thank you!</h3>
					<p className='form__text form-finish__text'>Thanks for confirming your subscription! We hope you have fun
